...
const setEmpRoleUpd = (answerObj, prmtIndex) => {
  let propValue = answerObj.answer;
  empRoleUpd[getPropName(answerObj.name)] = propValue;
  return ++prmtIndex;
}

const setEmpMgmUpd = (answerObj, prmtIndex) => {
  let propValue = answerObj.answer;
  empMgmUpd[getPropName(answerObj.name)] = propValue;
  console.log("upd object ", empMgmUpd);
  return ++prmtIndex;
}
